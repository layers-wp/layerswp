 ...
 * Image Control
 *
 * This file is used to register and display the custom Hatch Color Image
 *
 * @package Hatch
 * @since Hatch 1.0
 */
if( !class_exists( 'Hatch_Customize_Image_Control' ) ) {

	class Hatch_Customize_Image_Control extends WP_Customize_Upload_Control {
		public $type = 'image';
		public $get_url;
		public $statuses;
...
} //!class_exists( 'Hatch_Customize_Image_Control' )