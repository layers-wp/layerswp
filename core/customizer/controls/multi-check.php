 ...
 * @since Hatch 1.0
 */
if( !class_exists( 'Hatch_Customize_Multicheck_Control' ) ) {

	class Hatch_Customize_Multicheck_Control extends WP_Customize_Control {
...
} // !class_exists( 'Hatch_Customize_Multicheck_Control' )