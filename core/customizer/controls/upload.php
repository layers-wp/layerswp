...
if( !class_exists( 'Hatch_Customize_Upload_Control' ) ) {

	class Hatch_Customize_Upload_Control extends WP_Customize_Control {
		public $type    = 'upload';
		public $removed = '';
		public $context;
...
} // !class_exists( 'Hatch_Customize_Upload_Control' )