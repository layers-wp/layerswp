...
class Layers_Customizer {
	...
	public function admin_enqueue_scripts() {
		...
		// Customizer general
		wp_enqueue_script(
			LAYERS_THEME_SLUG . '-admin-customizer', get_template_directory_uri() . '/core/customizer/js/customizer.js', array(
			'backbone',
			'jquery',
			'wp-color-picker'
			), LAYERS_VERSION, true
	...
	public function admin_print_styles() {
		...
		// Widget styles
		wp_register_style(
			LAYERS_THEME_SLUG . '-admin-customizer', get_template_directory_uri() . '/core/customizer/css/customizer.css', array(), LAYERS_VERSION
		);
	...
	public function render_actions_buttons() {
		?>
