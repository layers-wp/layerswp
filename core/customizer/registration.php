...
class Layers_Customizer_Regsitrar {
	...
	public function register_sections( $sections = array() ) {
		...
		foreach ( $sections as $section_key => $section_data ) {
			...
			$this->customizer->add_section(
				$this->prefix . $section_key, $section_data
			);
	...
	public function register_controls( $panel_section_key = '', $controls = array() ) {
		...
		if ( !isset( $controls[$panel_section_key] ) )
			return;
		...
		foreach ( $controls[$panel_section_key] as $control_key => $control_data ) {
			...
			if ( 'layers-select-images' == $control_data['type'] ) {
				...
				$this->customizer->add_control(
					...
					$this->customizer, $setting_key, $control_data
					)
				);
				...
				// Add Setting
				$this->customizer->add_setting(
					$setting_key . '-background-heading', array(
					'default' => ( isset( $control_data['default'] ) ? $control_data['default'] : NULL ),
					'type' => 'theme_mod',
					'capability' => 'manage_options'
					)
				...
				$this->customizer->add_control(
					new Layers_Customize_Heading_Control(
					$this->customizer, $setting_key . '-background-heading', $duplicate_control_data
					)
				);
				...
				// Add Setting
				$this->customizer->add_setting(
					$setting_key . '-background-image', array(
					'default' => ( isset( $control_data['default'] ) ? $control_data['default'] : NULL ),
					'type' => 'theme_mod',
					'capability' => 'manage_options'
					)
				...
				$this->customizer->add_control(
					new Layers_Customize_Select_Image_Control(
					$this->customizer, $setting_key . '-background-image', $duplicate_control_data
					)
				);
				...
				$this->customizer->add_setting(
					$setting_key . '-background-color', array(
					'default' => ( isset( $control_data['default'] ) ? $control_data['default'] : NULL ),
					'type' => 'theme_mod',
					'capability' => 'manage_options'
					)
				...
				$this->customizer->add_control(
					new Layers_Customize_Color_Control(
					$this->customizer, $setting_key . '-background-color', $duplicate_control_data
					)
				);
				...
				$this->customizer->add_setting(
					$setting_key . '-background-repeat', array(
					'default' => ( isset( $control_data['default'] ) ? $control_data['default'] : NULL ),
					'type' => 'theme_mod',
					'capability' => 'manage_options'
					)
				...
				$this->customizer->add_control(
					new Layers_Customize_Select_Control(
					$this->customizer, $setting_key . '-background-repeat', $duplicate_control_data
					)
				);
				...
				$this->customizer->add_setting(
					$setting_key . '-background-position', array(
					'default' => ( isset( $control_data['default'] ) ? $control_data['default'] : NULL ),
					'type' => 'theme_mod',
					'capability' => 'manage_options'
					)
				...
				$this->customizer->add_control(
					new Layers_Customize_Select_Control(
					$this->customizer, $setting_key . '-background-position', $duplicate_control_data
					)
				);
				...
				$this->customizer->add_setting(
					$setting_key . '-background-stretch', array(
					'default' => ( isset( $control_data['default'] ) ? $control_data['default'] : NULL ),
					'type' => 'theme_mod',
					'capability' => 'manage_options'
					)
				...
				$this->customizer->add_control(
					new Layers_Customize_Checkbox_Control(
					$this->customizer, $setting_key . '-background-stretch', $duplicate_control_data
					)
				);
			} else {
	...
	public function register_control_defaults( $key = NULL, $value = NULL ) {
		...
		if ( !isset( $layers_customizer_defaults ) )
			$layers_customizer_defaults = array();
