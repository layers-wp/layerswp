...
<section class="hatch-container hatch-content-large">
	...
	<div class="hatch-section-title hatch-large invert hatch-content-massive" style="background: url(<?php echo get_template_directory_uri(); ?>/images/beta-zero.jpg) center no-repeat; background-size: cover;">
		<div class="hatch-container">
			...
			<div class="hatch-row hatch-well hatch-content-large hatch-push-bottom">
				<div class="hatch-section-title">
					...
					<p class="hatch-excerpt">
						Our intention of Beta Zero is to gather feedback around the page building interface. We have high ambitions and much to build however for now we have
						set some limits:
					</p>
				</div>
				<div class="hatch-row">
					...
					<div class="hatch-column hatch-span-6">
						...
						<ul class="hatch-feature-list">
							...
							<li class="cross">Switch between different fonts</li>
			...
			<footer class="hatch-row hatch-well hatch-content-small hatch-push-bottom">
				<p>
					Hatch is a product of <a href="http://oboxthemes.com/theme/">Obox Themes</a>. Please note that this software is not redistributable.
				</p>
			</footer>
