...
class Site_Logo {
	...
	public function preview_enqueue() {
		wp_enqueue_script( 'site-logo-preview', HATCH_TEMPLATE_URI . '/core/third_party/site-logo/js/site-logo.js' , array( 'media-views' ), '', true );

		// Don't bother passing in header text classes if the theme supports custom headers.
		if ( ! current_theme_supports( 'custom-header' ) ) {
			$classes = $this->header_text_classes();
			wp_enqueue_script( 'site-logo-header-text', HATCH_TEMPLATE_URI . '/core/third_party/site-logo/js/site-logo-header-text.js' , array( 'media-views' ), '', true );
