					...
					<div class="pages animate">
			 		...
			 		<div class="swiper-wrapper">
						...
						<?php foreach ( $widget[ 'banners' ] as $key => $banner) {
							...
							if( !empty( $banner['design'][ 'background' ] ) ) hatch_inline_styles( $widget_id . '-' . $key , 'background', array( 'background' => $banner['design'][ 'background' ] ) );
							if( !empty( $banner['design']['fonts'][ 'color' ] ) ) hatch_inline_styles( $widget_id . '-' . $key , 'color', array( 'selectors' => array( 'h3.heading', 'h3.heading a', 'div.excerpt' ) , 'color' => $banner['design']['fonts'][ 'color' ] ) );
							if( !empty( $banner['design']['fonts'][ 'shadow' ] ) ) hatch_inline_styles( $widget_id . '-' . $key , 'text-shadow', array( 'selectors' => array( 'h3.heading', 'h3.heading a',  'div.excerpt' )  , 'text-shadow' => $banner['design']['fonts'][ 'shadow' ] ) );
