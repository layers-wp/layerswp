		...
		*/
		function Layers_Content_Widget(){
			...
			*
			...
			/* Widget settings. */
			$widget_ops = array( 'classname' => 'obox-layers-' . $this->widget_id .'-widget', 'description' => _x( 'This widget is used to display your ', 'Content widget' , 'layerswp' ) . $this->widget_title . '.' );
