	...
	class Layers_Slider_Widget extends Layers_Widget {
		...
		*/
	 	function Layers_Slider_Widget(){
			...
			*/
			$this->widget_title = __( 'Slider', 'layers' );
						...
						'elements' => array(
							'layout' => array(
								...
								'options' => array(
									...
									'layout-full-screen' => __( 'Full Screen' , 'layers' )
								)
							)
						)
					),
					'display' => array(
						...
						'elements' => array(
								'show_slider_arrows' => array(
									...
									'label' => __( 'Show Slider Arrows', 'layers' )
								),
								'show_slider_dots' => array(
									...
									'label' => __( 'Show Slider Dots', 'layers' )
								),
								'autoplay_slides' => array(
									...
									'label' => __( 'Autoplay Slides', 'layers' )
								),
								'slide_time' => array(
									'type' => 'number',
									...
									'min' => 1,
									'max' => 10,
									'placeholder' => __( 'Leave blank for no slide', 'layers' ),
									'value' => ( isset( $slide_time ) ) ? $slide_time : NULL,
									'label' => __( 'Slide Interval', 'layers' )
								),
								'slide_height' => array(
									'type' => 'number',
			...
			<div class="layers-container-large" id="layers-slide-widget-<?php echo $this->number; ?>">
				...
				<section class="layers-accordion-section layers-content">
						...
						<ul id="slide_list_<?php echo $this->number; ?>" class="layers-accordions layers-accordions-sortable layers-sortable" data-id_base="<?php echo $this->id_base; ?>" data-number="<?php echo $this->number; ?>">
							...
							<?php }?>
							<li class="layers-button btn-primary layers-add-widget-slide" data-number="<?php echo $this->number; ?>"><?php _e( '+ Add New Slider' , 'layers' ) ; ?></li>
						</ul>
			...
			if( !isset( $this->slide_item_count ) ) {
				...
				<li class="layers-accordion-item <?php echo $this->slide_item_count; ?>" data-guid="<?php echo $slide_guid; ?>">
					<a class="layers-accordion-title">
						<span>
							<?php _e( 'Slider' , 'layers' ); ?><span class="layers-detail"><?php echo ( isset( $title ) ? ': ' . stripslashes( $title ) : NULL ); ?></span>
						</span>
					</a>
					<section class="layers-accordion-section layers-content">
						<?php $this->design_bar(
						...
						<div class="layers-row">
							<p class="layers-form-item">
								<label for="<?php echo $this->get_custom_field_id( $widget_details, 'slides',  $column_guid, 'title' ); ?>"><?php _e( 'Title' , 'layers' ); ?></label>
								<?php echo $this->form_elements()->input(
									array(
										'type' => 'text',
										...
										'placeholder' => __( 'Enter a Title' , 'layers' ),
							...
							<p class="layers-form-item">
								<label for="<?php echo $this->get_custom_field_id( $widget_details, 'slides',  $column_guid, 'excerpt' ); ?>"><?php _e( 'Excerpt' , 'layers' ); ?></label>
								<?php echo $this->form_elements()->input(
									array(
										'type' => 'textarea',
							...
							<div class="layers-row">
								<p class="layers-form-item layers-column layers-span-6">
									<label for="<?php echo $this->get_field_id( 'link' ); ?>"><?php _e( 'Button Link' , 'layers' ); ?></label>
									<?php echo $this->form_elements()->input(
										array(
											'type' => 'text',
											...
											'placeholder' => __( 'http://', 'layers' ),
											'value' => ( isset( $link ) ) ? $link : NULL ,
										)
									); ?>
								</p>
								<p class="layers-form-item layers-column layers-span-6">
									<label for="<?php echo $this->get_field_id( 'link' ); ?>"><?php _e( 'Button Text' , 'layers' ); ?></label>
									<?php echo $this->form_elements()->input(
										array(
											'type' => 'text',
