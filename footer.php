		...
		<footer id="footer" class="footer-site">
			...
			<div class="<?php if ( 'layout-fullwidth' != layers_get_theme_mod( 'footer-width' ) ) echo 'container'; ?>  clearfix">
				...
				<?php if ( 0 != $footer_sidebar_count ) : ?>
					...
					<div class="row">
						<?php
						// Default Sidebar count to 4
						if ( '' == $footer_sidebar_count ) {
							$footer_sidebar_count = 4;
						}
						...
						<?php for ( $footer = 1; $footer <= $footer_sidebar_count; $footer++ ) : ?>
							<div class="column span-<?php echo esc_attr( $footer_sidebar_class ); ?><?php echo ( $footer == $footer_sidebar_count ) ? ' last' : ''; ?>">
