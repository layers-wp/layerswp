...
<body <?php body_class(); ?>>
	...
	<div <?php layer_site_wrapper_class(); ?>>
		...
		<section <?php layers_header_class(); ?> >
            ...
            <div class="<?php if( 'layout-fullwidth' != layers_get_theme_mod( 'header-width' ) ) echo 'container'; ?> header-block do-animate animated-1s delay-200 layers-default-fade-in-down">
